...
class ChatbotEngines:
    ...
    # 意图处理
    def intentAction(self,data,intent,confidence,query):
    ...
    #后置检查，
    def afterCheck(self,data,intent):
        self.n.query(
    ...
    # 前置检查
    def preInspection(self,contentData,query):
        # 获取历史input
    ...
    # 后置检查
    def postInspection(self,contentData,query):
